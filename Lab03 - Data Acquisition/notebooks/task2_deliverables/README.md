# TASK 1
getting repos infro about tensorflow, pytorch, scikit-learn found that the one with highest stars per day is tensorflow written in C++ and least is scikit-learn written in python.
also that pytorch i sthe one with most open issues.

# TASK 2
tried getting all repos for user "torvalds" who craeted repos linux.
